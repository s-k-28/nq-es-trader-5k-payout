...
if __name__ == '__main__':
    ...
    iters = {
        ...
        4: lambda: run_single("PD risk $1200->$1800", CFG, "'pd_rev': 1200", "'pd_rev': 1800"),
        ...
        14: lambda: run_single("DLC $1200->$1500", CFG, "dollar_loss_cap: float = 1200.0", "dollar_loss_cap: float = 1500.0"),
        ...
        19: lambda: run_single("Tier-3 risk $600->$800", CFG,
        ...
        23: lambda: run_single("Payout pct 50%->40%", CFG, "payout_balance_pct: float = 0.50", "payout_balance_pct: float = 0.40"),
