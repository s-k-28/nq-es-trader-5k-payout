...
def main():
    ...
    plan = [
        ...
        (4, "PD risk $1200→$1800", 'one',
         CFG, "'pd_rev': 1200", "'pd_rev': 1800"),
        ...
        (14, "DLC $1200→$1500", 'one',
         CFG, "dollar_loss_cap: float = 1200.0", "dollar_loss_cap: float = 1500.0"),
